...
class Agent:
    ...
    def __init__(self):
        self.number_games = 0  # games counter
        self.epsilon = 0  # randomness
        self.gamma = 0.9  # discount rate
        self.memory = deque(maxlen=MAX_M)  # popleft
    ...
    def train_long_mem(self):
        if len(self.memory) > BATCH_S:
            mini_sample = random.sample(self.memory, BATCH_S)  # list of tuples
        else:
